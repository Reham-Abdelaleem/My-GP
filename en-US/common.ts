const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'LamaPBX account',
    langGeniusAccountTip: 'Your LamaPBX account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to LamaPBX to access your team data.',
